...
|---|---|---|
| Nome | **Convocami**, package `it.cyb3rdm0n.convocami` | La parola *è* la funzione, e gli utenti sono italiani: un gioco di parole che va spiegato non sta funzionando. Scartati *CallMeApp* e *CallMeUp*: «call me up» in inglese vuol dire *telefonami* — attaccato sembrava un'app per chiamate, e con quel nome sullo store ci sono già altre app. Il package è stato rinominato prima della pubblicazione, che è l'ultimo momento in cui si poteva |
